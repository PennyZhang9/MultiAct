...
class PtTransformer(nn.Module):
    ...
    def preprocessing(self, video_list, padding_val=0.0):
        ...
        # batched_inputs: [2, 2304, 9216] batched_masks: [2, 1, 9216]
    ...
    def label_points_single_video(self, concat_points, gt_segment, gt_label):
        ...
        # invalid_mask = (min_len == float('inf'))
        # min_len_inds[invalid_mask] = reg_targets.shape[1] - 1
        ...
        # print("max(min_len_inds):", max(min_len_inds))
