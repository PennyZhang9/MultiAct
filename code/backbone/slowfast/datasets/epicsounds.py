...
class Epicsounds(torch.utils.data.Dataset):
    ...
    def _construct_loader(self):
        ...
        elif self.mode == "test":  # validation file
        ...
        self._video_records = [] # 40175 ，
        self._temporal_idx = []  # 40175
        for file in path_annotations_pickle:
    ...
    def __getitem__(self, index):
        ...
        if self.audio_dataset is None:
            # print(self.cfg.EPICSOUNDS.AUDIO_DATA_FILE) # /path/to/EPIC_audio.hdf5
        ...
        # Normalization.
        spectrogram = spectrogram.float() # [1, 400, 128]
