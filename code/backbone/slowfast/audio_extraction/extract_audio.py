...
if __name__ == '__main__':
    ...
    parser.add_argument('--videos_dir', default=None, help='Directory of EPIC-KITCHENS videos with audio')
    parser.add_argument('--output_dir', default=None, help='Directory to save EPIC-KITCHENS audio')
