...
if __name__ == '__main__':
    ...
    parser.add_argument('--audio_dir', default=None, help='Directory of EPIC-KITCHENS audio')
    parser.add_argument('--output_dir', default=None, help='Directory to save the HDF5 audio dataset')
    parser.add_argument('--sampling_rate', type=int, default=24000, help='Sampling rate of audio in EPIC-KITCHENS')
    parser.add_argument('--processes', type=int, default=10, help='Number of processes for multiprocessing')
